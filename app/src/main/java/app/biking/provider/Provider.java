...
import app.biking.provider.base.BaseContentProvider;
...
public class Provider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "app.biking.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return BicingOpenHelper.getInstance(getContext());
    }
